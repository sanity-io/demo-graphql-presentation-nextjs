...
import type { MoreStoriesQueryData } from '@/sanity/lib/queries'
import { defineDataAttribute } from '@/sanity/lib/utils'

export default function MoreStories(props: { data: MoreStoriesQueryData }) {
  const data = Array.isArray(props.data?.allPost) ? props.data.allPost : []
